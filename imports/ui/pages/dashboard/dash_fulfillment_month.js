import './dash_fulfillment_month.html';
...
Template.dash_fulfillment_month.created = function () {
    Meteor.subscribe('agregateFufillmentDay.week');
    this.isSubs = new ReactiveVar(false);


}
Template.dash_fulfillment_month.helpers({
    orderByDate: function () {
        return AgregateFulfillmentDay.find({}, { sort: { 'startDate': -1 }, limit: 30 });
    },
